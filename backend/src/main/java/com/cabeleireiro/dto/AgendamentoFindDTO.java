...
public class AgendamentoFindDTO implements Serializable {
	...
	public AgendamentoFindDTO() {

	}

	public AgendamentoFindDTO(Integer id, LocalDate data, HorarioEnum horario, ServicoDTO servicoDTO) {
		this.id = id;
		this.data = data;
	...
	public AgendamentoFindDTO(Agendamento obj) {
		this.id = obj.getId();
